            ...
            <Container fluid className="main-height">
                ...
                <Row>
                    <Col lg={12}>
                     ...
                     <Row>
                         <Col lg={5}>
                        <p className="mt-3 p-with-logo">In <img src={HorizontalLogo} className="in-text-logo"/> According our project details, you’re beneficiary of our partner program, here you could find the information about the latest deposits made for your wallet address</p>
                         </Col>
                         <Col lg={7}>
                         <div className="mt-5">
